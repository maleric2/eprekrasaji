        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                foreach ($this->prekrsaji as $key => $value) {
                    ...
                    echo "<td><a href='".URL."korisnici/prekrsaji/details/{$value['id_prekrsaji']}'>Details</a> </td>";
                    if ($this->currentUser['id_tipKorisnika'] > 1) {
                        ...
                        echo "<td><a href='" . URL . "/korisnici/zalbe/0/{$value['id_prekrsaji']}'>Žalbe</a> </td>";
                    }
                    echo "</tr>";
                    $brojac++;
                }
