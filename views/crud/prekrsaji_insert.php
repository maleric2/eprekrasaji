<h1 class="center">Novi prekrsaj <?php //echo $this->user['korIme'] ?></h1>
   ...
   ?>
  <form id="forma3" name="details" class="form-horizontal" action="<?php echo URL ?>crud/prekrsaji/insert/" method="POST" >
      <fieldset class="panel panel-default">
          <div class="panel-body">
              <div class="form-group">
                <label class="col-md-4 control-label"" for="datum">Datum</label>
                <div class="col-md-5">
                    <input class="input-md form-control" type="date" autofocus name="ime" id="ime" >
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-5">
                    <input class="form-control" type="datetime" id="vrijeme_zastare" name="vrijeme_zastare">
                </div>
              </div>
