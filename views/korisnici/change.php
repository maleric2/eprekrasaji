<h1 class="center">Detalji korisnika <?php echo $this->user['korIme'] ?></h1>
 ...
 if ($this->user['id_statusRacuna'] == 1) {
  ...
  ?>
  <form id="forma3" name="details" action="<?php echo URL ?>register/update" method="POST" >
                <label class="registracija" for="ime">Ime</label>
                <input class="registracija" type="text" autofocus name="ime" id="ime" value="<?php echo $this->user['ime'];?>" >
                <label class="registracija" for="prezime">Prezime</label>
                <input class="registracija" type="text" name="prezime" id="prezime" value="<?php echo $this->user['prezime'];?>"  >
                <label class="registracija" for="oib">OIB</label>
                <input class="registracija" type="number" name="oib" id="oib" value="<?php echo $this->user['oib'];?>">
                <label class="registracija" for="adresa">Adresa</label>
                <input class="registracija" type="text" name="adresa" id="adresa" value="<?php echo $this->user['adresa'];?>" >
                ...
                <input class="registracija" type="email" id="email" name="email" value="<?php echo $this->user['email'];?>" >
                ...
                <input class="registracija" type="text" id="pass" name="pass" value="<?php echo $this->user['lozinka'];?>" > 
                <label class="registracija" for="slika">Putanja slike</label>
                <input class="registracija" type="text" id="slika" name="slika" value="<?php echo $this->user['putanja'];?>" readonly disabled >
                <input type="submit" name="promjeni" value="Ažuriraj" class="gumb">
 </form>
<article id="blok">
